...
export default function Hero() {
  ...
  return (
    <section className="relative flex min-h-[100dvh] items-center overflow-x-clip pt-16">
      ...
      <div className="relative mx-auto w-full max-w-6xl px-4 py-16 sm:px-8 sm:py-24 lg:py-28">
        <div className="grid items-center gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:gap-20">
          <div className="animate-fade-up min-w-0">
            ...
            <h1 className="font-display text-[2rem] font-bold leading-[1.15] tracking-tight break-words sm:text-5xl lg:text-6xl xl:text-7xl">
            ...
            <div className="mt-8 flex w-full flex-col gap-3 sm:mt-10 sm:flex-row sm:flex-wrap sm:items-center">
              <RippleLink
                ...
                className="inline-flex w-full items-center justify-center rounded-full bg-gradient-to-r from-cyan-500 to-violet-500 px-7 py-3.5 text-sm font-semibold text-white shadow-lg shadow-cyan-500/25 hover:shadow-cyan-500/40 sm:w-auto"
              >
                {t.hero.viewWork}
              ...
              <RippleLink
                ...
                className="inline-flex w-full items-center justify-center rounded-full border border-white/10 bg-white/5 px-7 py-3.5 text-sm font-semibold text-white backdrop-blur-sm hover:bg-white/10 sm:w-auto"
              >
                <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            <div className="mt-8 flex flex-col gap-3 text-sm text-slate-500 sm:mt-12 sm:flex-row sm:flex-wrap sm:gap-x-6 sm:gap-y-3">
          ...
          <div className="animate-fade-up animation-delay-200 mx-auto w-full max-w-[280px] sm:max-w-sm lg:mx-0 lg:max-w-none">
            <div className="flex flex-col items-center gap-5">
              ...
              <div className="grid w-full grid-cols-3 gap-3">
                {[
                  ...
                  <div
                    key={stat.label}
                    className={`rounded-xl border ${stat.border} bg-white/[0.03] px-3 py-3 text-center backdrop-blur-sm transition-colors duration-300 hover:bg-white/[0.06]`}
                  >
